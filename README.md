...
The goal of this project is to efficiently analyze and compare a handful of gentrified neighborhoods in New York City in order to identify patterns, trends, and consequences that inform both current and future urban planning strategies. 
...
Important Decades
Harlem: 1980s, 1990s, 2000s, 2010s, 2020s. 
Lower East Side: 1980s, 1990s, 2000’s,  2010s, 2020s. .
We will include a visualization of each neighborhood during each decade to demonstrate the gentrification progression and the drastic changes that come with that.

ArcGIS Storymap Completed
The conclusion will provide current reports on both areas, demonstrating how decades of gentrification have transformed both areas to their current states. We will describe the consequences of this gentrification for those historically residing in these areas.
